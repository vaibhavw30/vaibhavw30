...
- **EPIC Lab**: training temporal convolutional networks for inverse dynamics on a powered knee-and-ankle prosthesis.
- **Trustworthy Robotics Lab**: finding truth directions inside LLMs and testing whether steering on them changes behavior.
- **GTSF**: quant developer/analyst on Georgia Tech's $3.1M student-managed fund.
- **BoxIt**: a storage marketplace where college students rent space from each other. Solo build; the source is private, but the [design docs](https://github.com/vaibhavw30/boxit-architecture) aren't.

Before this: software engineering internships at DataMorph.ai (2026), OddsOn (2025), and RIA Advisory (2024).
...
**Outside of code**: cooking, which turned into a garden, which turned into beekeeping. Competitive debate (made it to #19 nationally), chess (around 1300), poker, basketball, fantasy football, and piano.

[vaibhavwudaru.com](https://vaibhavwudaru.com) · [LinkedIn](https://linkedin.com/in/vaibhavwudaru)
